...
export const Day: React.FC<Day> = ({ className, toDay, nextDay }) => {
  ...
  const isToday: boolean = date === dateToString(day, currentMonth, year);
  ...
  return (
    <div
      className={classNames(
        isToday ? "Day Day__current_day" : "Day",
        className
      )}
    >
      <div className="Day__number-of-the-month">
        <span>{day}</span>
      </div>
